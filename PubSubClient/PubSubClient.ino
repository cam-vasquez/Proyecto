...
const char *ssid = "Fam Chevez";
const char *passwd = "chevez0547";

//*************** CONFIGURACIÓN DE MQTT ****************
char *server = "192.168.0.12";
int port = 1883;
const char *mqtt_user = "sofia";
const char *mqtt_password = "avena";
...
const unsigned long measurementInterval = 60000; // Intervalo de medición en ms (5 segundos)
